...
export const LEVELS: LevelConfig[] = [
  ...
  { level: 12, gridCount: 40, carousel: true, carouselSpeed: 170, carouselGap: 10, carouselCols: 6, carouselShakiness: 0.2, carouselSameDirection: true,  carouselVertical: true },
  { level: 13, gridCount: 38, carousel: true, carouselSpeed: 180, carouselGap: 4,  carouselCols: 7, carouselShakiness: 0.4, carouselSameDirection: true  },
  { level: 14, gridCount: 40, carousel: true, carouselSpeed: 220, carouselGap: 2,  carouselCols: 7, carouselShakiness: 0.4, carouselSameDirection: false },
  { level: 15, gridCount: 42, carousel: true, carouselSpeed: 230, carouselGap: 4,  carouselCols: 7, carouselShakiness: 0.3, carouselSameDirection: true  },
  { level: 16, gridCount: 42, carousel: true, carouselSpeed: 235, carouselGap: 4,  carouselCols: 6, carouselShakiness: 0.3, carouselSameDirection: false, carouselVertical: true },
  { level: 17, gridCount: 42, carousel: true, carouselSpeed: 240, carouselGap: 2,  carouselCols: 7, carouselShakiness: 0.3, carouselSameDirection: false },
